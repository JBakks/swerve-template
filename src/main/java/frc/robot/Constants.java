...
public final class Constants {
    ...
    public static final double FRONT_LEFT_MODULE_STEER_OFFSET = Math.toRadians(12);//Math.toRadians(4.28);//154541015625;//-Math.toRadians(359.931); // FIXME Measure and set front left steer offset
    ...
    public static final double FRONT_RIGHT_MODULE_STEER_OFFSET = Math.toRadians(-4);//Math.toRadians(356.08);//2880859375; // FIXME Measure and set front right steer offset
    ...
    public static final double BACK_LEFT_MODULE_STEER_OFFSET = Math.toRadians(2.27);// -Math.toRadians(7.05);//03466796875; // FIXME Measure and set back left steer offset
    ...
    public static final double BACK_RIGHT_MODULE_STEER_OFFSET = Math.toRadians(1.78);//-Math.toRadians(177.40);//2470703125; // FIXME Measure and set back right steer offset
}
