...
public final class Constants {
     ...
     */
    public static final double DRIVETRAIN_TRACKWIDTH_METERS = 0.584;
    /**
     * The front-to-back distance between the drivetrain wheels.
     *
     * Should be measured from center to center.
     */
    public static final double DRIVETRAIN_WHEELBASE_METERS = 0.584; 


    public static final int FRONT_LEFT_MODULE_DRIVE_MOTOR = 41; // FIXME Set front left module drive motor ID
    ...
    public static final double FRONT_LEFT_MODULE_STEER_OFFSET = -Math.toRadians(357);//Math.toRadians(4.28);//154541015625;//-Math.toRadians(359.931); // FIXME Measure and set front left steer offset
    ...
    public static final double FRONT_RIGHT_MODULE_STEER_OFFSET = -Math.toRadians(1.73);//Math.toRadians(356.08);//2880859375; // FIXME Measure and set front right steer offset
    ...
    public static final double BACK_LEFT_MODULE_STEER_OFFSET = -Math.toRadians(355);// -Math.toRadians(7.05);//03466796875; // FIXME Measure and set back left steer offset
    ...
    public static final double BACK_RIGHT_MODULE_STEER_OFFSET = -Math.toRadians(359);//-Math.toRadians(177.40);//2470703125; // FIXME Measure and set back right steer offset
}
